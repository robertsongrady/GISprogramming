...
class Tool(object):
    def __init__(self):
        ...
        self.description = "Determines which buildings on TAMUs campus are near building of intrest"
    ...
    def getParameterInfo(self):
        ...
        param1=arcpy.Parameter(displayName="work GDB_Name",name="GDB_Name", datatype="GPString", parameterType="Required",direction="Input")
        ...
        param4=arcpy.Parameter(displayName="campus GDB folder path",name="campus GDBfolderpath", datatype="DEFolder", parameterType="Required", direction="Input")
